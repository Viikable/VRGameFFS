...
//     version 1.2.0
//     from Assets/Samples/XR Interaction Toolkit/2.0.0-pre.6/Default Input Actions/Custom Input Actions.inputactions
//
...
public partial class @CustomInputActions : IInputActionCollection2, IDisposable
{
    ...
    public struct XRIHMDActions
    {
        ...
        public XRIHMDActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomInputActions m_Wrapper;
        public XRILeftHandActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomInputActions m_Wrapper;
        public XRIRightHandActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }

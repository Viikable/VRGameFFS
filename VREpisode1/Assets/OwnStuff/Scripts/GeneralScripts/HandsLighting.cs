...
public class HandsLighting : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Game_Manager.instance.RightGrab.firstInteractableSelected != null || Game_Manager.instance.LeftGrab.firstInteractableSelected != null)
            {
                if (Game_Manager.instance.RightGrab.firstInteractableSelected != null && !Game_Manager.instance.RightGrab.firstInteractableSelected.transform.gameObject.CompareTag("Rope"))
                {
                    Game_Manager.instance.RightGrab.EndManualInteraction();
                }
                if (Game_Manager.instance.LeftGrab.firstInteractableSelected != null && !Game_Manager.instance.LeftGrab.firstInteractableSelected.transform.gameObject.CompareTag("Rope"))
                {
